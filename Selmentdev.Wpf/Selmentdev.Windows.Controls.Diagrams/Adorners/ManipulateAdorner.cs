...
{
    public class ManipulateAdorner : Adorner
    {
        private VisualCollection m_Visuals;
        private ManipulateChrome m_Chrome;
        ...
        public ManipulateAdorner(DiagramItem diagramItem)
            : base(diagramItem)
        {
            SnapsToDevicePixels = true;
            this.m_Chrome = new ManipulateChrome();
