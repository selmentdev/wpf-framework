...
namespace Selmentdev.Windows.Controls.Diagrams.Primitives
{
    public class SizeAdorner : Adorner
    {
        ...
        public SizeAdorner(DiagramItem diagramItem)
            : base(diagramItem)
        {
            this.SnapsToDevicePixels = true;
            this.m_DiagramItem = diagramItem;
            this.m_Chrome = new SizeChrome();
        ...
        {
            this.m_Chrome.Arrange(new Rect(new Point(0.0, 0.0), arrangeBounds));
